	...
	<tr>
		<td align="center" valign="top" style="margin:0px;padding:0px;border:0px;">
			<table cellspacing="0" cellpadding="0" style="margin:0px;padding:0px;border:0px;">
				...
				<tr>
					<td align="center" height="40" style="margin:0px;padding:0px;border:0px;"><img src="<!--server-->images/invitation_logo.gif" border="0"></td>
				</tr>
			</table>
		</td>
	</tr>
...
<input type="text"  value="<!--username-->" id="lz_invitation_name" style="position:absolute;left:105px;top:146px;background-color:#e0e0e0;background-image:url('<!--server-->templates/invitations/<!--template-->/textbox.gif');background-repeat:no-repeat;border:0px;height:20px;width:164px;font-size:11px;color:#707070;padding-left:3px;line-height:18px;">
